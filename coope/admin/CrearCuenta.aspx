<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/admin/admin.Master" CodeBehind="CrearCuenta.aspx.vb" Inherits="coope.CrearCuenta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div id="main-header" class="page-header">
      <span class="titular1 block linea1bottom"> <asp:Label runat="server" ID="lbltitulo" Text ="Creación de Cuentas"></asp:Label><br/></span>
    </div>  
                                 ...
                                 <tbody> 
                                      ...
                                      <tr>
                                              ...
                                              <tr>
                                                    ...
                                                    <asp:Button ID="btnAceptar" runat="server" Text="Crear Cuenta" CssClass="btn" />
