<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/admin/admin.Master" CodeBehind="frmRptRetiros.aspx.vb" Inherits="coope.frmRptRetiros" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div id="main-header" class="page-header">
      <span class="titular1 block linea1bottom">Lista de retiros <asp:Label runat="server" ID="lbltitulo" Text =""></asp:Label>
          <br/></span>
    </div>
        ...
        <div class="span12 widget">
            ...
            <div class="widget-content form-container">
                <table class="table table-striped table-detail-view">
                    <tbody>
                        <tr>
                            <th>Fecha de aplicación de retiro:</th>
                            <td>
                                <asp:Calendar ID="ClFecha" runat="server" Width="300px"></asp:Calendar>
                            </td>                           
                        </tr>
                        <tr>
                            <th>Retiros a procesar</th>
                            <td></td>                           
                        </tr>
