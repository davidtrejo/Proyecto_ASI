...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div id="main-header" class="page-header">
      <span class="titular1 block linea1bottom">Cargar Archivo de Planilla <asp:Label runat="server" ID="lbltitulo" Text =""></asp:Label>
          <br/></span>
    </div>
                        ...
                        <tr>
                         ...
                         <tr class="auto-style3">
                            <td colspan ="2" class="auto-style3">
                                <asp:Button ID="btnImport" runat="server" Text="Importar Datos" OnClick="btnImport_Click" />
                            </td>
                        </tr>
